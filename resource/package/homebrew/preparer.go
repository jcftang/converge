...
// Preparer for Homebrew Package
//
// Homebrew Package manages system packages with `brew`. It assumes that
// `brew` is installed on the system, and that the user has
...
func (p *Preparer) Prepare(ctx context.Context, render resource.Renderer) (resource.Task, error) {
	...
	return &pkg.Package{
		Name:   p.Name,
		State:  p.State,
		PkgMgr: &HomebrewManager{Sys: pkg.ExecCaller{}},
	}, nil
}

func init() {
	registry.Register("package.homebrew", (*Preparer)(nil), (*pkg.Package)(nil))
}
